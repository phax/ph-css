 ...
 * Test data from: http://www-archive.mozilla.org/quality/networking/testing/datatests.html
 *
 * @author Philip Helger
 */
public final class CSSDataURLHelperTest
{
  private static final String [] VALID_PLAIN = { "data:",
                                                 "data:,",
                                                 "data:text/plain,",
                                                 "data:,;test",
  ...
  private static final String [] VALID_BASE64 = { "data:;base64,",
                                                  "data:;base64",
  ...
  private static final String [] INVALID = { "data:;base64,äöü" };
  ...
  public void testParseDataURL ()
  {
    for (final String sValid : VALID_PLAIN)
    {
      ...
      TestHelper.testDefaultImplementationWithEqualContentObject (aURL, aURL2);

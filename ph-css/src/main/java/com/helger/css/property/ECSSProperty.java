...
public enum ECSSProperty implements IHasName, ICSSVersionAware
{
  ...
  ANIMATION_DELAY ("animation-delay", ECSSVersion.CSS30, CSS3_ANIMATIONS),
  ANIMATION_DIRECTION ("animation-direction", ECSSVersion.CSS30, CSS3_ANIMATIONS),
  ANIMATION_DURATION ("animation-duration", ECSSVersion.CSS30, CSS3_ANIMATIONS),
  ANIMATION_FILL_MODE ("animation-fill-mode", ECSSVersion.CSS30, CSS3_ANIMATIONS),
  ANIMATION_ITERATION_COUNT ("animation-iteration-count", ECSSVersion.CSS30, CSS3_ANIMATIONS),
  ANIMATION_NAME ("animation-name", ECSSVersion.CSS30, CSS3_ANIMATIONS),
  ANIMATION_PLAY_STATE ("animation-play-state", ECSSVersion.CSS30, CSS3_ANIMATIONS),
  ANIMATION_TIMING_FUNCTION ("animation-timing-function", ECSSVersion.CSS30, CSS3_ANIMATIONS),
  AZIMUTH ("azimuth", ECSSVersion.CSS21, CSS2),
  BACKFACE_VISIBILITY ("backface-visibility", ECSSVersion.CSS30, CSS_TRANSFORMS_1),
  BACKGROUND ("background", ECSSVersion.CSS10, CSS1, CSS2, CSS3_BACKGROUND),
  BACKGROUND_ATTACHMENT ("background-attachment", ECSSVersion.CSS10, CSS1, CSS2, CSS3_BACKGROUND),
  BACKGROUND_BLEND_MODE ("background-blend-mode", ECSSVersion.CSS30, COMPOSITING_1),
  BACKGROUND_CLIP ("background-clip", ECSSVersion.CSS30, CSS3_BACKGROUND),
  BACKGROUND_COLOR ("background-color", ECSSVersion.CSS10, CSS1, CSS2, CSS3_BACKGROUND),
  BACKGROUND_IMAGE ("background-image", ECSSVersion.CSS10, CSS1, CSS2, CSS3_BACKGROUND),
  BACKGROUND_ORIGIN ("background-origin", ECSSVersion.CSS30, CSS3_BACKGROUND),
  BACKGROUND_POSITION ("background-position", ECSSVersion.CSS10, CSS1, CSS2, CSS3_BACKGROUND),
  ...
  BORDER_BOTTOM_LEFT_RADIUS ("border-bottom-left-radius", ECSSVersion.CSS30, CSS3_BACKGROUND),
  BORDER_BOTTOM_RIGHT_RADIUS ("border-bottom-right-radius", ECSSVersion.CSS30, CSS3_BACKGROUND),
  BORDER_BOTTOM_STYLE ("border-bottom-style", ECSSVersion.CSS21, CSS2, CSS3_BACKGROUND),
  BORDER_BOTTOM_WIDTH ("border-bottom-width", ECSSVersion.CSS10, CSS1, CSS2, CSS3_BACKGROUND),
  BORDER_COLLAPSE ("border-collapse", ECSSVersion.CSS21, CSS2),
  BORDER_COLOR ("border-color", ECSSVersion.CSS10, CSS1, CSS2, CSS3_BACKGROUND),
  BORDER_IMAGE ("border-image", ECSSVersion.CSS30, CSS3_BACKGROUND),
  BORDER_IMAGE_OUTSET ("border-image-outset", ECSSVersion.CSS30, CSS3_BACKGROUND),
  BORDER_IMAGE_REPEAT ("border-image-repeat", ECSSVersion.CSS30, CSS3_BACKGROUND),
  BORDER_IMAGE_SLICE ("border-image-slice", ECSSVersion.CSS30, CSS3_BACKGROUND),
  BORDER_IMAGE_SOURCE ("border-image-source", ECSSVersion.CSS30, CSS3_BACKGROUND),
  BORDER_IMAGE_WIDTH ("border-image-width", ECSSVersion.CSS30, CSS3_BACKGROUND),
  BORDER_LEFT ("border-left", ECSSVersion.CSS10, CSS1, CSS2, CSS3_BACKGROUND),
  BORDER_LEFT_COLOR ("border-left-color", ECSSVersion.CSS21, CSS2, CSS3_BACKGROUND),
  BORDER_LEFT_STYLE ("border-left-style", ECSSVersion.CSS21, CSS2, CSS3_BACKGROUND),
  BORDER_LEFT_WIDTH ("border-left-width", ECSSVersion.CSS10, CSS1, CSS2, CSS3_BACKGROUND),
  BORDER_RADIUS ("border-radius", ECSSVersion.CSS30, CSS3_BACKGROUND),
  BORDER_RIGHT ("border-right", ECSSVersion.CSS10, CSS1, CSS2, CSS3_BACKGROUND),
  BORDER_RIGHT_COLOR ("border-right-color", ECSSVersion.CSS21, CSS2, CSS3_BACKGROUND),
  BORDER_RIGHT_STYLE ("border-right-style", ECSSVersion.CSS21, CSS2, CSS3_BACKGROUND),
  BORDER_RIGHT_WIDTH ("border-right-width", ECSSVersion.CSS10, CSS1, CSS2, CSS3_BACKGROUND),
  BORDER_SPACING ("border-spacing", ECSSVersion.CSS21, CSS2),
  BORDER_STYLE ("border-style", ECSSVersion.CSS10, CSS1, CSS2, CSS3_BACKGROUND),
  BORDER_TOP ("border-top", ECSSVersion.CSS10, CSS1, CSS2, CSS3_BACKGROUND),
  BORDER_TOP_COLOR ("border-top-color", ECSSVersion.CSS21, CSS2, CSS3_BACKGROUND),
  BORDER_TOP_LEFT_RADIUS ("border-top-left-radius", ECSSVersion.CSS30, CSS3_BACKGROUND),
  BORDER_TOP_RIGHT_RADIUS ("border-top-right-radius", ECSSVersion.CSS30, CSS3_BACKGROUND),
  BORDER_TOP_STYLE ("border-top-style", ECSSVersion.CSS21, CSS2, CSS3_BACKGROUND),
  BORDER_TOP_WIDTH ("border-top-width", ECSSVersion.CSS10, CSS1, CSS2, CSS3_BACKGROUND),
  BORDER_WIDTH ("border-width", ECSSVersion.CSS10, CSS1, CSS2, CSS3_BACKGROUND),
  BOTTOM ("bottom", ECSSVersion.CSS21, CSS2, CSS_POSITION_3),
  BOX_DECORATION_BREAK ("box-decoration-break", ECSSVersion.CSS30, CSS_BREAK_3),
  BOX_SHADOW ("box-shadow", ECSSVersion.CSS30, CSS3_BACKGROUND),
  BOX_SIZING ("box-sizing", ECSSVersion.CSS30, CSS_UI_3),
  BOX_SNAP ("box-snap", ECSSVersion.CSS30, CSS_LINE_GRID_1),
  BOX_SUPPRESS ("box-suppress", ECSSVersion.CSS30, CSS_DISPLAY_3),
  BREAK_AFTER ("break-after", ECSSVersion.CSS30, CSS3_MULTICOL, CSS_BREAK_3, CSS_REGIONS_1),
  BREAK_BEFORE ("break-before", ECSSVersion.CSS30, CSS3_MULTICOL, CSS_BREAK_3, CSS_REGIONS_1),
  BREAK_INSIDE ("break-inside", ECSSVersion.CSS30, CSS3_MULTICOL, CSS_BREAK_3, CSS_REGIONS_1),
  CAPTION_SIDE ("caption-side", ECSSVersion.CSS21, CSS2),
  CARET_COLOR ("caret-color", ECSSVersion.CSS30, CSS_UI_3),
  CHAINS ("chains", ECSSVersion.CSS30, CSS_TEMPLATE_3),
  CLEAR ("clear", ECSSVersion.CSS10, CSS1, CSS2),
  CLIP ("clip", ECSSVersion.CSS21, CSS2, CSS_POSITION_3, CSS_MASKING_1),
  CLIP_PATH ("clip-path", ECSSVersion.CSS30, CSS_MASKING_1),
  CLIP_RULE ("clip-rule", ECSSVersion.CSS30, CSS_MASKING_1),
  COLOR ("color", ECSSVersion.CSS10, CSS1, CSS2, CSS3_COLOR),
  COLOR_INTERPOLATION_FILTERS ("color-interpolation-filters", ECSSVersion.CSS30, FILTER_EFFECTS_1),
  COLUMNS ("columns", ECSSVersion.CSS30, CSS3_MULTICOL),
  COLUMNS_SPAN ("columns-span", ECSSVersion.CSS30, CSS3_MULTICOL),
  COLUMNS_WIDTH ("columns-width", ECSSVersion.CSS30, CSS3_MULTICOL),
  COLUMN_COUNT ("column-count", ECSSVersion.CSS30, CSS3_MULTICOL),
  COLUMN_FILL ("column-fill", ECSSVersion.CSS30, CSS3_MULTICOL),
  COLUMN_GAP ("column-gap", ECSSVersion.CSS30, CSS3_MULTICOL),
  COLUMN_RULE ("column-rule", ECSSVersion.CSS30, CSS3_MULTICOL),
  COLUMN_RULE_COLOR ("column-rule-color", ECSSVersion.CSS30, CSS3_MULTICOL),
  COLUMN_RULE_STYLE ("column-rule-style", ECSSVersion.CSS30, CSS3_MULTICOL),
  COLUMN_RULE_WIDTH ("column-rule-width", ECSSVersion.CSS30, CSS3_MULTICOL),
  COLUMN_WIDTH ("column-width", ECSSVersion.CSS30, CSS3_MULTICOL),
  CONTAIN ("contain", ECSSVersion.CSS30, CSS_CONTAIN_1),
  CONTENT ("content", ECSSVersion.CSS21, CSS2, CSS_UI_3),
  COUNTER_INCREMENT ("counter-increment", ECSSVersion.CSS21, CSS2, CSS_LISTS_3),
  COUNTER_RESET ("counter-reset", ECSSVersion.CSS21, CSS2, CSS_LISTS_3),
  COUNTER_SET ("counter-set", ECSSVersion.CSS30, CSS_LISTS_3),
  CUE ("cue", ECSSVersion.CSS21, CSS2, CSS3_SPEECH),
  CUE_AFTER ("cue-after", ECSSVersion.CSS21, CSS2, CSS3_SPEECH),
  CUE_BEFORE ("cue-before", ECSSVersion.CSS21, CSS2, CSS3_SPEECH),
  CURSOR ("cursor", ECSSVersion.CSS21, CSS2, CSS_UI_3),
  DIRECTION ("direction", ECSSVersion.CSS21, CSS2, CSS_WRITING_MODES_3),
  DISPLAY ("display", ECSSVersion.CSS10, CSS1, CSS2, CSS_TEMPLATE_3, CSS_RUBY_1, CSS_DISPLAY_3),
  DISPLAY_INSIDE ("display-inside", ECSSVersion.CSS30, CSS_DISPLAY_3),
  DISPLAY_LIST ("display-list", ECSSVersion.CSS30, CSS_DISPLAY_3),
  DISPLAY_OUTSIDE ("display-outside", ECSSVersion.CSS30, CSS_DISPLAY_3),
  DOMINANT_BASELINE ("dominant-baseline", ECSSVersion.CSS30, CSS_INLINE_3),
  DROP_INITIAL_AFTER_ADJUST ("drop-initial-after-adjust", ECSSVersion.CSS30, CSS_INLINE_3),
  DROP_INITIAL_AFTER_ALIGN ("drop-initial-after-align", ECSSVersion.CSS30, CSS_INLINE_3),
  DROP_INITIAL_BEFORE_ADJUST ("drop-initial-before-adjust", ECSSVersion.CSS30, CSS_INLINE_3),
  DROP_INITIAL_BEFORE_ALIGN ("drop-initial-before-align", ECSSVersion.CSS30, CSS_INLINE_3),
  DROP_INITIAL_SIZE ("drop-initial-size", ECSSVersion.CSS30, CSS_INLINE_3),
  ...
  FLEX_DIRECTION ("flex-direction", ECSSVersion.CSS30, CSS_FLEXBOX_1),
  FLEX_FLOW ("flex-flow", ECSSVersion.CSS30, CSS_FLEXBOX_1),
  FLEX_GROW ("flex-grow", ECSSVersion.CSS30, CSS_FLEXBOX_1),
  ...
  FLOW_INTO ("flow-into", ECSSVersion.CSS30, CSS_REGIONS_1),
  FONT ("font", ECSSVersion.CSS10, CSS1, CSS2, CSS_FONTS_3),
  FONT_FAMILY ("font-family", ECSSVersion.CSS10, CSS1, CSS2, CSS_FONTS_3),
  FONT_FEATURE_SETTINGS ("font-feature-settings", ECSSVersion.CSS30, CSS_FONTS_3),
  FONT_KERNING ("font-kerning", ECSSVersion.CSS30, CSS_FONTS_3),
  FONT_LANGUAGE_OVERRIDE ("font-language-override", ECSSVersion.CSS30, CSS_FONTS_3),
  FONT_SIZE ("font-size", ECSSVersion.CSS10, CSS1, CSS2, CSS_FONTS_3),
  FONT_SIZE_ADJUST ("font-size-adjust", ECSSVersion.CSS30, CSS_FONTS_3),
  FONT_STRETCH ("font-stretch", ECSSVersion.CSS30, CSS_FONTS_3),
  FONT_STYLE ("font-style", ECSSVersion.CSS10, CSS1, CSS2, CSS_FONTS_3),
  FONT_SYNTHESIS ("font-synthesis", ECSSVersion.CSS30, CSS_FONTS_3),
  FONT_VARIANT ("font-variant", ECSSVersion.CSS10, CSS1, CSS2, CSS_FONTS_3),
  FONT_VARIANT_ALTERNATES ("font-variant-alternates", ECSSVersion.CSS30, CSS_FONTS_3),
  FONT_VARIANT_CAPS ("font-variant-caps", ECSSVersion.CSS30, CSS_FONTS_3),
  FONT_VARIANT_EAST_ASIAN ("font-variant-east-asian", ECSSVersion.CSS30, CSS_FONTS_3),
  FONT_VARIANT_LIGATURES ("font-variant-ligatures", ECSSVersion.CSS30, CSS_FONTS_3),
  FONT_VARIANT_NUMERIC ("font-variant-numeric", ECSSVersion.CSS30, CSS_FONTS_3),
  FONT_VARIANT_POSITION ("font-variant-position", ECSSVersion.CSS30, CSS_FONTS_3),
  FONT_WEIGHT ("font-weight", ECSSVersion.CSS10, CSS1, CSS2, CSS_FONTS_3),
  FOOTNOTE_DISPLAY ("footnote-display", ECSSVersion.CSS30, CSS_GCPM_3),
  FOOTNOTE_POLICY ("footnote-policy", ECSSVersion.CSS30, CSS_GCPM_3),
  GLYPH_ORIENTATION_VERTICAL ("glyph-orientation-vertical", ECSSVersion.CSS30, CSS_WRITING_MODES_3),
  GRID ("grid", ECSSVersion.CSS30, CSS_GRID_1),
  ...
  GRID_TEMPLATE_ROWS ("grid-template-rows", ECSSVersion.CSS30, CSS_GRID_1),
  HANGING_PUNCTUATION ("hanging-punctuation", ECSSVersion.CSS30, CSS_TEXT_3),
  HEIGHT ("height", ECSSVersion.CSS10, CSS1, CSS2, CSS_DEVICE_ADAPT_1),
  HYPHENS ("hyphens", ECSSVersion.CSS30, CSS_TEXT_3),
  ICON ("icon", ECSSVersion.CSS30, CSS_UI_3),
  IMAGE_ORIENTATION ("image-orientation", ECSSVersion.CSS30, CSS3_IMAGES),
  IMAGE_RESOLUTION ("image-resolution", ECSSVersion.CSS30, CSS3_IMAGES),
  IME_MODE ("ime-mode", ECSSVersion.CSS30, CSS_UI_3),
  INLINE_BOX_ALIGN ("inline-box-align", ECSSVersion.CSS30, CSS_INLINE_3),
  ISOLATION ("isolation", ECSSVersion.CSS30, COMPOSITING_1),
  JUSITFY_CONTENT ("justify-content", ECSSVersion.CSS30, CSS_FLEXBOX_1, CSS_ALIGN_3),
  JUSITFY_ITEMS ("justify-items", ECSSVersion.CSS30, CSS_ALIGN_3),
  JUSITFY_SELF ("justify-self", ECSSVersion.CSS30, CSS_ALIGN_3),
  LEFT ("left", ECSSVersion.CSS21, CSS2, CSS_POSITION_3),
  LETTER_SPACING ("letter-spacing", ECSSVersion.CSS10, CSS1, CSS2, CSS_TEXT_3),
  LIGHTING_COLOR ("lighting-color", ECSSVersion.CSS30, FILTER_EFFECTS_1),
  LINE_BREAK ("line-break", ECSSVersion.CSS30, CSS_TEXT_3),
  LINE_GRID ("line-grid", ECSSVersion.CSS30, CSS_LINE_GRID_1),
  LINE_HEIGHT ("line-height", ECSSVersion.CSS10, CSS1, CSS2, CSS_INLINE_3),
  LINE_SNAP ("line-snap", ECSSVersion.CSS30, CSS_LINE_GRID_1),
  LINE_STACKING ("line-stacking", ECSSVersion.CSS30, CSS_INLINE_3),
  LINE_STACKING_RUBY ("line-stacking-ruby", ECSSVersion.CSS30, CSS_INLINE_3),
  LINE_STACKING_SHIFT ("line-stacking-shift", ECSSVersion.CSS30, CSS_INLINE_3),
  LINE_STACKING_STRATEGY ("line-stacking-strategy", ECSSVersion.CSS30, CSS_INLINE_3),
  LIST_STYLE ("list-style", ECSSVersion.CSS10, CSS1, CSS2, CSS_LISTS_3),
  LIST_STYLE_IMAGE ("list-style-image", ECSSVersion.CSS10, CSS1, CSS2, CSS_LISTS_3),
  LIST_STYLE_POSITION ("list-style-position", ECSSVersion.CSS10, CSS1, CSS2, CSS_LISTS_3),
  LIST_STYLE_TYPE ("list-style-type", ECSSVersion.CSS10, CSS1, CSS2, CSS_LISTS_3),
  MARGIN ("margin", ECSSVersion.CSS10, CSS1, CSS2),
  MARGIN_BOTTOM ("margin-bottom", ECSSVersion.CSS10, CSS1, CSS2),
  MARGIN_LEFT ("margin-left", ECSSVersion.CSS10, CSS1, CSS2),
  ...
  MASK_BORDER_REPEAT ("mask-border-repeat", ECSSVersion.CSS30, CSS_MASKING_1),
  ...
  MASK_MODE ("mask-mode", ECSSVersion.CSS30, CSS_MASKING_1),
  MASK_ORIGIN ("mask-origin", ECSSVersion.CSS30, CSS_MASKING_1),
  ...
  MAX_WIDTH ("max-width", ECSSVersion.CSS21, CSS2, CSS_DEVICE_ADAPT_1),
  MAX_ZOOM ("max-zoom", ECSSVersion.CSS30, CSS_DEVICE_ADAPT_1),
  MIN_HEIGHT ("min-height", ECSSVersion.CSS21, CSS2, CSS_DEVICE_ADAPT_1),
  MIN_WIDTH ("min-width", ECSSVersion.CSS21, CSS2, CSS_DEVICE_ADAPT_1),
  MIN_ZOOM ("min-zoom", ECSSVersion.CSS30, CSS_DEVICE_ADAPT_1),
  MIX_BLEND_MODE ("mix-blend-mode", ECSSVersion.CSS30, COMPOSITING_1),
  NAV_DOWN ("nav-down", ECSSVersion.CSS30, CSS_UI_3),
  NAV_INDEX ("nav-index", ECSSVersion.CSS30, CSS_UI_3),
  NAV_LEFT ("nav-left", ECSSVersion.CSS30, CSS_UI_3),
  NAV_RIGHT ("nav-right", ECSSVersion.CSS30, CSS_UI_3),
  NAV_UP ("nav-up", ECSSVersion.CSS30, CSS_UI_3),
  OBJECT_FIT ("object-fit", ECSSVersion.CSS30, CSS3_IMAGES),
  OBJECT_POSITION ("object-position", ECSSVersion.CSS30, CSS3_IMAGES),
  OPACITY ("opacity", ECSSVersion.CSS30, CSS3_COLOR),
  ORDER ("order", ECSSVersion.CSS30, CSS_FLEXBOX_1),
  ORIENTATION ("orientation", ECSSVersion.CSS30, CSS_DEVICE_ADAPT_1),
  ORPHANS ("orphans", ECSSVersion.CSS21, CSS2, CSS_BREAK_3),
  OUTLINE ("outline", ECSSVersion.CSS21, CSS2, CSS_UI_3),
  OUTLINE_COLOR ("outline-color", ECSSVersion.CSS21, CSS2, CSS_UI_3),
  OUTLINE_OFFSET ("outline-offset", ECSSVersion.CSS30, CSS_UI_3),
  ...
  PADDING ("padding", ECSSVersion.CSS10, CSS1, CSS2),
  PADDING_BOTTOM ("padding-bottom", ECSSVersion.CSS10, CSS1, CSS2),
  PADDING_LEFT ("padding-left", ECSSVersion.CSS10, CSS1, CSS2),
  PADDING_RIGHT ("padding-right", ECSSVersion.CSS10, CSS1, CSS2),
  PADDING_TOP ("padding-top", ECSSVersion.CSS10, CSS1, CSS2),
  PAGE_BREAK_AFTER ("page-break-after", ECSSVersion.CSS21, CSS2),
  PAGE_BREAK_BEFORE ("page-break-before", ECSSVersion.CSS21, CSS2),
  PAGE_BREAK_INSIDE ("page-break-inside", ECSSVersion.CSS21, CSS2),
  PAUSE ("pause", ECSSVersion.CSS21, CSS2, CSS3_SPEECH),
  PAUSE_AFTER ("pause-after", ECSSVersion.CSS21, CSS2, CSS3_SPEECH),
  PAUSE_BEFORE ("pause-before", ECSSVersion.CSS21, CSS2, CSS3_SPEECH),
  PERSPECTIVE ("perspective", ECSSVersion.CSS30, CSS_TRANSFORMS_1),
  PERSPECTIVE_ORIGIN ("perspective-origin", ECSSVersion.CSS30, CSS_TRANSFORMS_1),
  PITCH ("pitch", ECSSVersion.CSS21, CSS2),
  PITCH_RANGE ("pitch-range", ECSSVersion.CSS21, CSS2),
  PLAY_DURING ("play-during", ECSSVersion.CSS21, CSS2),
  POSITION ("position", ECSSVersion.CSS21, CSS2, CSS_POSITION_3, CSS_TEMPLATE_3),
  QUOTES ("quotes", ECSSVersion.CSS21, CSS2),
  REGION_FRAGMENT ("region-fragment", ECSSVersion.CSS30, CSS_REGIONS_1),
  RESIZE ("resize", ECSSVersion.CSS30, CSS_UI_3),
  RESOLUTION ("resolution", ECSSVersion.CSS30, CSS_DEVICE_ADAPT_1),
  REST ("rest", ECSSVersion.CSS30, CSS3_SPEECH),
  REST_AFTER ("rest-after", ECSSVersion.CSS30, CSS3_SPEECH),
  REST_BEFORE ("rest-before", ECSSVersion.CSS30, CSS3_SPEECH),
  RICHNESS ("richness", ECSSVersion.CSS21, CSS2),
  ...
  SHAPE_IMAGE_THRESHOLD ("shape-image-threshold", ECSSVersion.CSS30, CSS_SHAPES_1),
  SHAPE_MARGIN ("shape-margin", ECSSVersion.CSS30, CSS_SHAPES_1),
  SIZE ("size", ECSSVersion.CSS30, CSS3_PAGE),
  SPEAK ("speak", ECSSVersion.CSS21, CSS2, CSS3_SPEECH),
  SPEAK_AS ("speak-as", ECSSVersion.CSS30, CSS3_SPEECH),
  SPEAK_HEADER ("speak-header", ECSSVersion.CSS21, CSS2),
  SPEAK_NUMERAL ("speak-numeral", ECSSVersion.CSS21, CSS2),
  SPEAK_PUNCTUATION ("speak-punctuation", ECSSVersion.CSS21, CSS2),
  SPEECH_RATE ("speech-rate", ECSSVersion.CSS21, CSS2),
  SRC ("src", ECSSVersion.CSS30, CSS_FONTS_3),
  STRESS ("stress", ECSSVersion.CSS21, CSS2),
  ...
  TEXT_DECORATION_LINE ("text-decoration-line", ECSSVersion.CSS30, CSS_TEXT_DECOR_3),
  TEXT_DECORATION_SKIP ("text-decoration-skip", ECSSVersion.CSS30, CSS_TEXT_DECOR_3),
  TEXT_DECORATION_STYLE ("text-decoration-style", ECSSVersion.CSS30, CSS_TEXT_DECOR_3),
  TEXT_EMPHASIS ("text-emphasis", ECSSVersion.CSS30, CSS_TEXT_DECOR_3),
  TEXT_EMPHASIS_COLOR ("text-emphasis-color", ECSSVersion.CSS30, CSS_TEXT_DECOR_3),
  TEXT_EMPHASIS_POSITION ("text-emphasis-position", ECSSVersion.CSS30, CSS_TEXT_DECOR_3),
  TEXT_EMPHASIS_STYLE ("text-emphasis-style", ECSSVersion.CSS30, CSS_TEXT_DECOR_3),
  TEXT_HEIGHT ("text-height", ECSSVersion.CSS30, CSS_INLINE_3),
  TEXT_INDENT ("text-indent", ECSSVersion.CSS10, CSS1, CSS2, CSS_TEXT_3),
  TEXT_JUSTIFY ("text-justify", ECSSVersion.CSS30, CSS_TEXT_3),
  TEXT_ORIENTATION ("text-orientation", ECSSVersion.CSS30, CSS_WRITING_MODES_3),
  TEXT_OVERFLOW ("text-overflow", ECSSVersion.CSS30, CSS_UI_3),
  TEXT_SHADOW ("text-shadow", ECSSVersion.CSS30, CSS_TEXT_DECOR_3),
  TEXT_TRANSFORM ("text-transform", ECSSVersion.CSS10, CSS1, CSS2, CSS_TEXT_3),
  TEXT_UNDERLINE_POSITION ("text-underline-position", ECSSVersion.CSS30, CSS_TEXT_DECOR_3),
  TOP ("top", ECSSVersion.CSS21, CSS2, CSS_POSITION_3),
  TOUCH_ACTION ("touch-action", ECSSVersion.CSS30, OUTSIDE_CSS),
  TRANSFORM ("transform", ECSSVersion.CSS30, CSS_TRANSFORMS_1),
  TRANSFORM_ORIGIN ("transform-origin", ECSSVersion.CSS30, CSS_TRANSFORMS_1),
  TRANSFORM_STYLE ("transform-style", ECSSVersion.CSS30, CSS_TRANSFORMS_1),
  TRANSITION ("transition", ECSSVersion.CSS30, CSS3_TRANSITIONS),
  TRANSITION_DELAY ("transition-delay", ECSSVersion.CSS30, CSS3_TRANSITIONS),
  TRANSITION_DURATION ("transition-duration", ECSSVersion.CSS30, CSS3_TRANSITIONS),
  TRANSITION_PROPERTY ("transition-property", ECSSVersion.CSS30, CSS3_TRANSITIONS),
  TRANSITION_TIMING_FUNCTION ("transition-timing-function", ECSSVersion.CSS30, CSS3_TRANSITIONS),
  UNICODE_BIDI ("unicode-bidi", ECSSVersion.CSS21, CSS2, CSS_WRITING_MODES_3),
  UNICODE_RANGE ("unicode-range", ECSSVersion.CSS30, CSS_FONTS_3),
  USER_ZOOM ("user-zoom", ECSSVersion.CSS30, CSS_DEVICE_ADAPT_1),
  VERTICAL_ALIGN ("vertical-align", ECSSVersion.CSS10, CSS1, CSS2, CSS_INLINE_3),
  VISIBILITY ("visibility", ECSSVersion.CSS21, CSS2),
  VOICE_BALANCE ("voice-balance", ECSSVersion.CSS30, CSS3_SPEECH),
  VOICE_DURATION ("voice-duration", ECSSVersion.CSS30, CSS3_SPEECH),
  VOICE_FAMILY ("voice-family", ECSSVersion.CSS21, CSS2, CSS3_SPEECH),
  VOICE_PITCH ("voice-pitch", ECSSVersion.CSS30, CSS3_SPEECH),
  VOICE_RANGE ("voice-range", ECSSVersion.CSS30, CSS3_SPEECH),
  VOICE_RATE ("voice-rate", ECSSVersion.CSS30, CSS3_SPEECH),
  VOICE_STRESS ("voice-stress", ECSSVersion.CSS30, CSS3_SPEECH),
  VOICE_VOLUME ("voice-volume", ECSSVersion.CSS30, CSS3_SPEECH),
  VOLUME ("volume", ECSSVersion.CSS21, CSS2),
  WHITE_SPACE ("white-space", ECSSVersion.CSS10, CSS1, CSS2, CSS_TEXT_3),
  WIDOWS ("widows", ECSSVersion.CSS21, CSS2, CSS_BREAK_3),
  WIDTH ("width", ECSSVersion.CSS10, CSS1, CSS2, CSS_DEVICE_ADAPT_1),
  WILL_CHANGE ("will-change", ECSSVersion.CSS30, CSS_WILL_CHANGE_1),
  WORD_BREAK ("word-break", ECSSVersion.CSS30, CSS_TEXT_3),
  WORD_SPACING ("word-spacing", ECSSVersion.CSS10, CSS1, CSS2, CSS_TEXT_3),
  ...
  WORD_WRAP ("word-wrap", ECSSVersion.CSS30, CSS_TEXT_3),
  WRAP_FLOW ("wrap-flow", ECSSVersion.CSS30, CSS3_EXCLUSIONS),
  WRAP_THROUGH ("wrap-through", ECSSVersion.CSS30, CSS3_EXCLUSIONS),

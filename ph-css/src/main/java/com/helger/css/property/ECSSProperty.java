...
{
  ALIGN_CONTENT ("align-content", ECSSVersion.CSS30, ECSSSpecification.CSS_FLEXBOX_1, ECSSSpecification.CSS_ALIGN_3),
  ALIGN_ITEMS ("align-items", ECSSVersion.CSS30, ECSSSpecification.CSS_FLEXBOX_1, ECSSSpecification.CSS_ALIGN_3),
  ALIGN_SELF ("align-self", ECSSVersion.CSS30, ECSSSpecification.CSS_FLEXBOX_1, ECSSSpecification.CSS_ALIGN_3),
  @Deprecated
  ALIGNMENT_ADJUST ("alignment-adjust", ECSSVersion.CSS30, ECSSSpecification.CSS_INLINE_3),
  ALIGNMENT_BASELINE ("alignment-baseline", ECSSVersion.CSS30, ECSSSpecification.CSS_INLINE_3),
  ALL ("all", ECSSVersion.CSS30, ECSSSpecification.CSS_CASCADE_3),
  ...
  BACKFACE_VISIBILITY ("backface-visibility", ECSSVersion.CSS30, ECSSSpecification.CSS_TRANSFORMS_1),
  BACKGROUND ("background",
              ECSSVersion.CSS10,
              ECSSSpecification.CSS1,
              ECSSSpecification.CSS2,
              ECSSSpecification.CSS3_BACKGROUND),
  BACKGROUND_ATTACHMENT ("background-attachment",
                         ECSSVersion.CSS10,
                         ECSSSpecification.CSS1,
                         ECSSSpecification.CSS2,
                         ECSSSpecification.CSS3_BACKGROUND),
  BACKGROUND_BLEND_MODE ("background-blend-mode", ECSSVersion.CSS30, ECSSSpecification.COMPOSITING_1),
  ...
  BASELINE_SHIFT ("baseline-shift", ECSSVersion.CSS30, ECSSSpecification.CSS_INLINE_3),
  @Deprecated
  BLEED ("bleed", ECSSVersion.CSS30, ECSSSpecification.CSS_GCPM_3),
  BOOKMARK_LABEL ("bookmark-label", ECSSVersion.CSS30, ECSSSpecification.CSS_GCPM_3),
  BOOKMARK_LEVEL ("bookmark-level", ECSSVersion.CSS30, ECSSSpecification.CSS_GCPM_3),
  BOOKMARK_STATE ("bookmark-state", ECSSVersion.CSS30, ECSSSpecification.CSS_GCPM_3),
  @Deprecated
  BOOKMARK_TARGET ("bookmark-target", ECSSVersion.CSS30, ECSSSpecification.CSS_GCPM_3),
  BORDER ("border",
          ECSSVersion.CSS10,
          ECSSSpecification.CSS1,
          ECSSSpecification.CSS2,
  ...
  BORDER_WIDTH ("border-width",
                ...
                ECSSSpecification.CSS2,
                ECSSSpecification.CSS3_BACKGROUND),
  BOTTOM ("bottom", ECSSVersion.CSS21, ECSSSpecification.CSS2, ECSSSpecification.CSS_POSITION_3),
  BOX_DECORATION_BREAK ("box-decoration-break", ECSSVersion.CSS30, ECSSSpecification.CSS3_BACKGROUND),
  BOX_SHADOW ("box-shadow", ECSSVersion.CSS30, ECSSSpecification.CSS3_BACKGROUND, ECSSSpecification.CSS_BREAK_3),
  BOX_SIZING ("box-sizing", ECSSVersion.CSS30, ECSSSpecification.CSS_UI_3),
  BOX_SNAP ("box-snap", ECSSVersion.CSS30, ECSSSpecification.CSS_LINE_GRID_1),
  BOX_SUPPRESS ("box-suppress", ECSSVersion.CSS30, ECSSSpecification.CSS_DISPLAY_3),
  BREAK_AFTER ("break-after",
               ECSSVersion.CSS30,
               ECSSSpecification.CSS3_MULTICOL,
               ECSSSpecification.CSS_BREAK_3,
               ECSSSpecification.CSS_REGIONS_1),
  ...
  CHAINS ("chains", ECSSVersion.CSS30, ECSSSpecification.CSS_TEMPLATE_3),
  CLEAR ("clear", ECSSVersion.CSS10, ECSSSpecification.CSS1, ECSSSpecification.CSS2),
  CLIP ("clip",
        ECSSVersion.CSS21,
        ECSSSpecification.CSS2,
        ECSSSpecification.CSS_POSITION_3,
        ECSSSpecification.CSS_MASKING_1),
  CLIP_PATH ("clip-path", ECSSVersion.CSS30, ECSSSpecification.CSS_MASKING_1),
  CLIP_RULE ("clip-rule", ECSSVersion.CSS30, ECSSSpecification.CSS_MASKING_1),
  COLOR ("color", ECSSVersion.CSS10, ECSSSpecification.CSS1, ECSSSpecification.CSS2, ECSSSpecification.CSS3_COLOR),
  COLOR_INTERPOLATION_FILTERS ("color-interpolation-filters", ECSSVersion.CSS30, ECSSSpecification.FILTER_EFFECTS_1),
  ...
  CONTENT ("content", ECSSVersion.CSS21, ECSSSpecification.CSS2, ECSSSpecification.CSS_UI_3),
  COUNTER_INCREMENT ("counter-increment", ECSSVersion.CSS21, ECSSSpecification.CSS2, ECSSSpecification.CSS_LISTS_3),
  COUNTER_RESET ("counter-reset", ECSSVersion.CSS21, ECSSSpecification.CSS2, ECSSSpecification.CSS_LISTS_3),
  COUNTER_SET ("counter-set", ECSSVersion.CSS30, ECSSSpecification.CSS_LISTS_3),
  ...
  CURSOR ("cursor", ECSSVersion.CSS21, ECSSSpecification.CSS2, ECSSSpecification.CSS_UI_3),
  DIRECTION ("direction", ECSSVersion.CSS21, ECSSSpecification.CSS2, ECSSSpecification.CSS_WRITING_MODES_3),
  DISPLAY ("display",
           ECSSVersion.CSS10,
           ECSSSpecification.CSS1,
           ECSSSpecification.CSS2,
           ECSSSpecification.CSS_TEMPLATE_3,
           ECSSSpecification.CSS_RUBY_1,
           ECSSSpecification.CSS_DISPLAY_3),
  ...
  DOMINANT_BASELINE ("dominant-baseline", ECSSVersion.CSS30, ECSSSpecification.CSS_INLINE_3),
  DROP_INITIAL_AFTER_ADJUST ("drop-initial-after-adjust", ECSSVersion.CSS30, ECSSSpecification.CSS_INLINE_3),
  DROP_INITIAL_AFTER_ALIGN ("drop-initial-after-align", ECSSVersion.CSS30, ECSSSpecification.CSS_INLINE_3),
  DROP_INITIAL_BEFORE_ADJUST ("drop-initial-before-adjust", ECSSVersion.CSS30, ECSSSpecification.CSS_INLINE_3),
  DROP_INITIAL_BEFORE_ALIGN ("drop-initial-before-align", ECSSVersion.CSS30, ECSSSpecification.CSS_INLINE_3),
  DROP_INITIAL_SIZE ("drop-initial-size", ECSSVersion.CSS30, ECSSSpecification.CSS_INLINE_3),
  DROP_INITIAL_VALUE ("drop-initial-value", ECSSVersion.CSS30, ECSSSpecification.CSS_INLINE_3),
  ...
  @Deprecated
  ENABLE_BACKGROUND ("enable-background", ECSSVersion.CSS30, ECSSSpecification.FILTER_EFFECTS_1),
  FILTER ("filter", ECSSVersion.CSS30, ECSSSpecification.FILTER_EFFECTS_1),
  FLEX ("flex", ECSSVersion.CSS30, ECSSSpecification.CSS_FLEXBOX_1),
  FLEX_BASIS ("flex-basis", ECSSVersion.CSS30, ECSSSpecification.CSS_FLEXBOX_1),
  FLEX_DIRECTION ("flex-direction", ECSSVersion.CSS30, ECSSSpecification.CSS_FLEXBOX_1),
  FLEX_FLOW ("flex-flow", ECSSVersion.CSS30, ECSSSpecification.CSS_FLEXBOX_1),
  FLEX_GROW ("flex-grow", ECSSVersion.CSS30, ECSSSpecification.CSS_FLEXBOX_1),
  FLEX_SHRINK ("flex-shrink", ECSSVersion.CSS30, ECSSSpecification.CSS_FLEXBOX_1),
  FLEX_WRAP ("flex-wrap", ECSSVersion.CSS30, ECSSSpecification.CSS_FLEXBOX_1),
  FLOAT ("float", ECSSVersion.CSS10, ECSSSpecification.CSS1, ECSSSpecification.CSS2),
  @Deprecated
  FLOAT_OFFSET ("float-offset", ECSSVersion.CSS30, ECSSSpecification.CSS_GCPM_3),
  FLOOD_COLOR ("flood-color", ECSSVersion.CSS30, ECSSSpecification.FILTER_EFFECTS_1),
  FLOOD_OPACITY ("flood-opactiy", ECSSVersion.CSS30, ECSSSpecification.FILTER_EFFECTS_1),
  FLOW_FROM ("flow-from", ECSSVersion.CSS30, ECSSSpecification.CSS_REGIONS_1),
  FLOW_INTO ("flow-into", ECSSVersion.CSS30, ECSSSpecification.CSS_REGIONS_1),
  FONT ("font", ECSSVersion.CSS10, ECSSSpecification.CSS1, ECSSSpecification.CSS2, ECSSSpecification.CSS_FONTS_3),
  FONT_FAMILY ("font-family",
               ECSSVersion.CSS10,
               ECSSSpecification.CSS1,
               ECSSSpecification.CSS2,
               ECSSSpecification.CSS_FONTS_3),
  FONT_FEATURE_SETTINGS ("font-feature-settings", ECSSVersion.CSS30, ECSSSpecification.CSS_FONTS_3),
  FONT_KERNING ("font-kerning", ECSSVersion.CSS30, ECSSSpecification.CSS_FONTS_3),
  FONT_LANGUAGE_OVERRIDE ("font-language-override", ECSSVersion.CSS30, ECSSSpecification.CSS_FONTS_3),
  FONT_SIZE ("font-size",
             ECSSVersion.CSS10,
             ECSSSpecification.CSS1,
             ECSSSpecification.CSS2,
             ECSSSpecification.CSS_FONTS_3),
  FONT_SIZE_ADJUST ("font-size-adjust", ECSSVersion.CSS30, ECSSSpecification.CSS_FONTS_3),
  FONT_STRETCH ("font-stretch", ECSSVersion.CSS30, ECSSSpecification.CSS_FONTS_3),
  FONT_STYLE ("font-style",
              ECSSVersion.CSS10,
              ECSSSpecification.CSS1,
              ECSSSpecification.CSS2,
              ECSSSpecification.CSS_FONTS_3),
  FONT_SYNTHESIS ("font-synthesis", ECSSVersion.CSS30, ECSSSpecification.CSS_FONTS_3),
  FONT_VARIANT ("font-variant",
                ECSSVersion.CSS10,
                ECSSSpecification.CSS1,
                ECSSSpecification.CSS2,
                ECSSSpecification.CSS_FONTS_3),
  FONT_VARIANT_ALTERNATES ("font-variant-alternates", ECSSVersion.CSS30, ECSSSpecification.CSS_FONTS_3),
  FONT_VARIANT_CAPS ("font-variant-caps", ECSSVersion.CSS30, ECSSSpecification.CSS_FONTS_3),
  FONT_VARIANT_EAST_ASIAN ("font-variant-east-asian", ECSSVersion.CSS30, ECSSSpecification.CSS_FONTS_3),
  FONT_VARIANT_LIGATURES ("font-variant-ligatures", ECSSVersion.CSS30, ECSSSpecification.CSS_FONTS_3),
  FONT_VARIANT_NUMERIC ("font-variant-numeric", ECSSVersion.CSS30, ECSSSpecification.CSS_FONTS_3),
  FONT_VARIANT_POSITION ("font-variant-position", ECSSVersion.CSS30, ECSSSpecification.CSS_FONTS_3),
  FONT_WEIGHT ("font-weight",
               ECSSVersion.CSS10,
               ECSSSpecification.CSS1,
               ECSSSpecification.CSS2,
               ECSSSpecification.CSS_FONTS_3),
  FOOTNOTE_DISPLAY ("footnote-display", ECSSVersion.CSS30, ECSSSpecification.CSS_GCPM_3),
  FOOTNOTE_POLICY ("footnote-policy", ECSSVersion.CSS30, ECSSSpecification.CSS_GCPM_3),
  GRID ("grid", ECSSVersion.CSS30, ECSSSpecification.CSS_GRID_1),
  GRID_AREA ("grid-area", ECSSVersion.CSS30, ECSSSpecification.CSS_GRID_1),
  GRID_AUTO_COLUMNS ("grid-auto-columns", ECSSVersion.CSS30, ECSSSpecification.CSS_GRID_1),
  GRID_AUTO_FLOW ("grid-auto-flow", ECSSVersion.CSS30, ECSSSpecification.CSS_GRID_1),
  @Deprecated
  GRID_AUTO_POSITION ("grid-auto-position", ECSSVersion.CSS30, ECSSSpecification.CSS_GRID_1),
  GRID_AUTO_ROWS ("grid-auto-rows", ECSSVersion.CSS30, ECSSSpecification.CSS_GRID_1),
  GRID_COLUMN ("grid-column", ECSSVersion.CSS30, ECSSSpecification.CSS_GRID_1),
  GRID_COLUMN_END ("grid-column-end", ECSSVersion.CSS30, ECSSSpecification.CSS_GRID_1),
  GRID_COLUMN_START ("grid-column-start", ECSSVersion.CSS30, ECSSSpecification.CSS_GRID_1),
  @Deprecated
  GRID_COLUMNS ("grid-columns", ECSSVersion.CSS30, ECSSSpecification.CSS3_GRID),
  GRID_ROW ("grid-row", ECSSVersion.CSS30, ECSSSpecification.CSS_GRID_1),
  GRID_ROW_END ("grid-row-end", ECSSVersion.CSS30, ECSSSpecification.CSS_GRID_1),
  GRID_ROW_START ("grid-row-start", ECSSVersion.CSS30, ECSSSpecification.CSS_GRID_1),
  @Deprecated
  GRID_ROWS ("grid-rows", ECSSVersion.CSS30, ECSSSpecification.CSS3_GRID),
  GRID_TEMPLATE ("grid-template", ECSSVersion.CSS30, ECSSSpecification.CSS_GRID_1),
  GRID_TEMPLATE_AREAS ("grid-template-areas", ECSSVersion.CSS30, ECSSSpecification.CSS_GRID_1),
  GRID_TEMPLATE_COLUMNS ("grid-template-columns", ECSSVersion.CSS30, ECSSSpecification.CSS_GRID_1),
  GRID_TEMPLATE_ROWS ("grid-template-rows", ECSSVersion.CSS30, ECSSSpecification.CSS_GRID_1),
  HANGING_PUNCTUATION ("hanging-punctuation", ECSSVersion.CSS30, ECSSSpecification.CSS_TEXT_3),
  HEIGHT ("height",
          ECSSVersion.CSS10,
          ECSSSpecification.CSS1,
          ECSSSpecification.CSS2,
          ECSSSpecification.CSS_DEVICE_ADAPT_1),
  HYPHENS ("hyphens", ECSSVersion.CSS30, ECSSSpecification.CSS_TEXT_3),
  ICON ("icon", ECSSVersion.CSS30, ECSSSpecification.CSS_UI_3),
  ...
  IME_MODE ("ime-mode", ECSSVersion.CSS30, ECSSSpecification.CSS_UI_3),
  INLINE_BOX_ALIGN ("inline-box-align", ECSSVersion.CSS30, ECSSSpecification.CSS_INLINE_3),
  ISOLATION ("isolation", ECSSVersion.CSS30, ECSSSpecification.COMPOSITING_1),
  JUSITFY_CONTENT ("justify-content",
                   ECSSVersion.CSS30,
                   ECSSSpecification.CSS_FLEXBOX_1,
                   ECSSSpecification.CSS_ALIGN_3),
  JUSITFY_ITEMS ("justify-items", ECSSVersion.CSS30, ECSSSpecification.CSS_ALIGN_3),
  JUSITFY_SELF ("justify-self", ECSSVersion.CSS30, ECSSSpecification.CSS_ALIGN_3),
  LEFT ("left", ECSSVersion.CSS21, ECSSSpecification.CSS2, ECSSSpecification.CSS_POSITION_3),
  LETTER_SPACING ("letter-spacing",
                  ECSSVersion.CSS10,
                  ECSSSpecification.CSS1,
                  ECSSSpecification.CSS2,
                  ECSSSpecification.CSS_TEXT_3),
  LIGHTING_COLOR ("lighting-color", ECSSVersion.CSS30, ECSSSpecification.FILTER_EFFECTS_1),
  LINE_BREAK ("line-break", ECSSVersion.CSS30, ECSSSpecification.CSS_TEXT_3),
  LINE_GRID ("line-grid", ECSSVersion.CSS30, ECSSSpecification.CSS_LINE_GRID_1),
  LINE_HEIGHT ("line-height",
               ECSSVersion.CSS10,
               ECSSSpecification.CSS1,
               ECSSSpecification.CSS2,
               ECSSSpecification.CSS_INLINE_3),
  LINE_SNAP ("line-snap", ECSSVersion.CSS30, ECSSSpecification.CSS_LINE_GRID_1),
  LINE_STACKING ("line-stacking", ECSSVersion.CSS30, ECSSSpecification.CSS_INLINE_3),
  LINE_STACKING_RUBY ("line-stacking-ruby", ECSSVersion.CSS30, ECSSSpecification.CSS_INLINE_3),
  LINE_STACKING_SHIFT ("line-stacking-shift", ECSSVersion.CSS30, ECSSSpecification.CSS_INLINE_3),
  LINE_STACKING_STRATEGY ("line-stacking-strategy", ECSSVersion.CSS30, ECSSSpecification.CSS_INLINE_3),
  LIST_STYLE ("list-style",
              ECSSVersion.CSS10,
              ECSSSpecification.CSS1,
              ECSSSpecification.CSS2,
              ECSSSpecification.CSS_LISTS_3),
  ...
  MARKER_SIDE ("marker-side", ECSSVersion.CSS30, ECSSSpecification.CSS_LISTS_3),
  @Deprecated
  MARKS ("marks", ECSSVersion.CSS30, ECSSSpecification.CSS_GCPM_3),
  @Deprecated
  ...
  MASK ("mask", ECSSVersion.CSS30, ECSSSpecification.CSS_MASKING_1),
  MASK_BORDER ("mask-border", ECSSVersion.CSS30, ECSSSpecification.CSS_MASKING_1),
  MASK_BORDER_MODE ("mask-border-mode", ECSSVersion.CSS30, ECSSSpecification.CSS_MASKING_1),
  MASK_BORDER_REPEAT ("mask-border-repeat", ECSSVersion.CSS30, ECSSSpecification.CSS_MASKING_1),
  MASK_BORDER_SLICE ("mask-border-slice", ECSSVersion.CSS30, ECSSSpecification.CSS_MASKING_1),
  MASK_BORDER_SOURCE ("mask-border-source", ECSSVersion.CSS30, ECSSSpecification.CSS_MASKING_1),
  MASK_BORDER_WIDTH ("mask-border-width", ECSSVersion.CSS30, ECSSSpecification.CSS_MASKING_1),
  @Deprecated
  MASK_BOX_IMAGE ("mask-box-image", ECSSVersion.CSS30, ECSSSpecification.CSS_MASKING_1),
  @Deprecated
  MASK_BOX_IMAGE_OUTSET ("mask-box-image-outset", ECSSVersion.CSS30, ECSSSpecification.CSS_MASKING_1),
  @Deprecated
  MASK_BOX_IMAGE_REPEAT ("mask-box-image-repeat", ECSSVersion.CSS30, ECSSSpecification.CSS_MASKING_1),
  @Deprecated
  MASK_BOX_IMAGE_SLICE ("mask-box-image-slice", ECSSVersion.CSS30, ECSSSpecification.CSS_MASKING_1),
  @Deprecated
  MASK_BOX_IMAGE_SOURCE ("mask-box-image-source", ECSSVersion.CSS30, ECSSSpecification.CSS_MASKING_1),
  @Deprecated
  MASK_BOX_IMAGE_WIDTH ("mask-box-image-width", ECSSVersion.CSS30, ECSSSpecification.CSS_MASKING_1),
  MASK_CLIP ("mask-clip", ECSSVersion.CSS30, ECSSSpecification.CSS_MASKING_1),
  MASK_COMPOSITE ("mask-composite", ECSSVersion.CSS30, ECSSSpecification.CSS_MASKING_1),
  MASK_IMAGE ("mask-image", ECSSVersion.CSS30, ECSSSpecification.CSS_MASKING_1),
  MASK_MODE ("mask-mode", ECSSVersion.CSS30, ECSSSpecification.CSS_MASKING_1),
  MASK_ORIGIN ("mask-origin", ECSSVersion.CSS30, ECSSSpecification.CSS_MASKING_1),
  MASK_POSITION ("mask-position", ECSSVersion.CSS30, ECSSSpecification.CSS_MASKING_1),
  MASK_REPEAT ("mask-repeat", ECSSVersion.CSS30, ECSSSpecification.CSS_MASKING_1),
  MASK_SIZE ("mask-size", ECSSVersion.CSS30, ECSSSpecification.CSS_MASKING_1),
  @Deprecated
  MASK_SOURCE_TYPE ("mask-source-type", ECSSVersion.CSS30, ECSSSpecification.CSS_MASKING_1),
  MASK_TYPE ("mask-type", ECSSVersion.CSS30, ECSSSpecification.CSS_MASKING_1),
  MAX_HEIGHT ("max-height", ECSSVersion.CSS21, ECSSSpecification.CSS2, ECSSSpecification.CSS_DEVICE_ADAPT_1),
  MAX_LINES ("max-lines", ECSSVersion.CSS30, ECSSSpecification.CSS_OVERFLOW_3),
  MAX_WIDTH ("max-width", ECSSVersion.CSS21, ECSSSpecification.CSS2, ECSSSpecification.CSS_DEVICE_ADAPT_1),
  MAX_ZOOM ("max-zoom", ECSSVersion.CSS30, ECSSSpecification.CSS_DEVICE_ADAPT_1),
  MIN_HEIGHT ("min-height", ECSSVersion.CSS21, ECSSSpecification.CSS2, ECSSSpecification.CSS_DEVICE_ADAPT_1),
  MIN_WIDTH ("min-width", ECSSVersion.CSS21, ECSSSpecification.CSS2, ECSSSpecification.CSS_DEVICE_ADAPT_1),
  MIN_ZOOM ("min-zoom", ECSSVersion.CSS30, ECSSSpecification.CSS_DEVICE_ADAPT_1),
  MIX_BLEND_MODE ("mix-blend-mode", ECSSVersion.CSS30, ECSSSpecification.COMPOSITING_1),
  NAV_DOWN ("nav-down", ECSSVersion.CSS30, ECSSSpecification.CSS_UI_3),
  NAV_INDEX ("nav-index", ECSSVersion.CSS30, ECSSSpecification.CSS_UI_3),
  NAV_LEFT ("nav-left", ECSSVersion.CSS30, ECSSSpecification.CSS_UI_3),
  NAV_RIGHT ("nav-right", ECSSVersion.CSS30, ECSSSpecification.CSS_UI_3),
  NAV_UP ("nav-up", ECSSVersion.CSS30, ECSSSpecification.CSS_UI_3),
  ...
  ORDER ("order", ECSSVersion.CSS30, ECSSSpecification.CSS_FLEXBOX_1),
  ORIENTATION ("orientation", ECSSVersion.CSS30, ECSSSpecification.CSS_DEVICE_ADAPT_1),
  ORPHANS ("orphans", ECSSVersion.CSS21, ECSSSpecification.CSS2, ECSSSpecification.CSS_BREAK_3),
  OUTLINE ("outline", ECSSVersion.CSS21, ECSSSpecification.CSS2, ECSSSpecification.CSS_UI_3),
  OUTLINE_COLOR ("outline-color", ECSSVersion.CSS21, ECSSSpecification.CSS2, ECSSSpecification.CSS_UI_3),
  OUTLINE_OFFSET ("outline-offset", ECSSVersion.CSS30, ECSSSpecification.CSS_UI_3),
  OUTLINE_STYLE ("outline-style", ECSSVersion.CSS21, ECSSSpecification.CSS2, ECSSSpecification.CSS_UI_3),
  OUTLINE_WIDTH ("outline-width", ECSSVersion.CSS21, ECSSSpecification.CSS2, ECSSSpecification.CSS_UI_3),
  ...
  OVERFLOW_WRAP ("overflow-wrap", ECSSVersion.CSS30, ECSSSpecification.CSS_TEXT_3),
  ...
  PERSPECTIVE ("perspective", ECSSVersion.CSS30, ECSSSpecification.CSS_TRANSFORMS_1),
  PERSPECTIVE_ORIGIN ("perspective-origin", ECSSVersion.CSS30, ECSSSpecification.CSS_TRANSFORMS_1),
  ...
  REGION_FRAGMENT ("region-fragment", ECSSVersion.CSS30, ECSSSpecification.CSS_REGIONS_1),
  RESIZE ("resize", ECSSVersion.CSS30, ECSSSpecification.CSS_UI_3),
  RESOLUTION ("resolution", ECSSVersion.CSS30, ECSSSpecification.CSS_DEVICE_ADAPT_1),
  ...
  RIGHT ("right", ECSSVersion.CSS21, ECSSSpecification.CSS2, ECSSSpecification.CSS_POSITION_3),
  RUBY_ALIGN ("ruby-align", ECSSVersion.CSS30, ECSSSpecification.CSS_RUBY_1),
  RUBY_MERGE ("ruby-merge", ECSSVersion.CSS30, ECSSSpecification.CSS_RUBY_1),
  @Deprecated
  RUBY_OVERHANG ("ruby-overhang", ECSSVersion.CSS30, ECSSSpecification.CSS_RUBY_1),
  RUBY_POSITION ("ruby-position", ECSSVersion.CSS30, ECSSSpecification.CSS_RUBY_1),
  @Deprecated
  RUBY_SPAN ("ruby-span", ECSSVersion.CSS30, ECSSSpecification.CSS_RUBY_1),
  RUNNING ("running", ECSSVersion.CSS30, ECSSSpecification.CSS_GCPM_3),
  SCROLL_BEHAVIOR ("scroll-behavior", ECSSVersion.CSS30, ECSSSpecification.CSSOM_VIEW_1),
  SHAPE_OUTSIDE ("shape-outside", ECSSVersion.CSS30, ECSSSpecification.CSS_SHAPES_1),
  SHAPE_IMAGE_THRESHOLD ("shape-image-threshold", ECSSVersion.CSS30, ECSSSpecification.CSS_SHAPES_1),
  SHAPE_MARGIN ("shape-margin", ECSSVersion.CSS30, ECSSSpecification.CSS_SHAPES_1),
  ...
  SRC ("src", ECSSVersion.CSS30, ECSSSpecification.CSS_FONTS_3),
  STRESS ("stress", ECSSVersion.CSS21, ECSSSpecification.CSS2),
  STRING_SET ("string-set", ECSSVersion.CSS30, ECSSSpecification.CSS_GCPM_3),
  TABLE_LAYOUT ("table-layout", ECSSVersion.CSS21, ECSSSpecification.CSS2),
  TAB_SIZE ("tab-size", ECSSVersion.CSS30, ECSSSpecification.CSS_TEXT_3),
  @Deprecated
  ...
  TEXT_ALIGN ("text-align",
              ...
              ECSSSpecification.CSS2,
              ECSSSpecification.CSS_TEXT_3),
  TEXT_ALIGN_LAST ("text-align-last", ECSSVersion.CSS30, ECSSSpecification.CSS_TEXT_3),
  @Deprecated
  TEXT_COMBINE_HORIZONTAL ("text-combine-horizontal", ECSSVersion.CSS30, ECSSSpecification.CSS_WRITING_MODES_3),
  TEXT_COMBINE_UPRIGHT ("text-combine-upright", ECSSVersion.CSS30, ECSSSpecification.CSS_WRITING_MODES_3),
  TEXT_DECORATION ("text-decoration",
                   ECSSVersion.CSS10,
                   ECSSSpecification.CSS1,
                   ECSSSpecification.CSS2,
                   ECSSSpecification.CSS_TEXT_DECOR_3),
  ...
  TEXT_HEIGHT ("text-height", ECSSVersion.CSS30, ECSSSpecification.CSS_INLINE_3),
  TEXT_INDENT ("text-indent",
               ECSSVersion.CSS10,
               ECSSSpecification.CSS1,
               ECSSSpecification.CSS2,
               ECSSSpecification.CSS_TEXT_3),
  TEXT_JUSTIFY ("text-justify", ECSSVersion.CSS30, ECSSSpecification.CSS_TEXT_3),
  TEXT_ORIENTATION ("text-orientation", ECSSVersion.CSS30, ECSSSpecification.CSS_WRITING_MODES_3),
  TEXT_OVERFLOW ("text-overflow", ECSSVersion.CSS30, ECSSSpecification.CSS_UI_3),
  ...
  TOP ("top", ECSSVersion.CSS21, ECSSSpecification.CSS2, ECSSSpecification.CSS_POSITION_3),
  TOUCH_ACTION ("touch-action", ECSSVersion.CSS30, ECSSSpecification.OUTSIDE_CSS),
  TRANSFORM ("transform", ECSSVersion.CSS30, ECSSSpecification.CSS_TRANSFORMS_1),
  TRANSFORM_ORIGIN ("transform-origin", ECSSVersion.CSS30, ECSSSpecification.CSS_TRANSFORMS_1),
  TRANSFORM_STYLE ("transform-style", ECSSVersion.CSS30, ECSSSpecification.CSS_TRANSFORMS_1),
  ...
  UNICODE_BIDI ("unicode-bidi", ECSSVersion.CSS21, ECSSSpecification.CSS2, ECSSSpecification.CSS_WRITING_MODES_3),
  UNICODE_RANGE ("unicode-range", ECSSVersion.CSS30, ECSSSpecification.CSS_FONTS_3),
  USER_ZOOM ("user-zoom", ECSSVersion.CSS30, ECSSSpecification.CSS_DEVICE_ADAPT_1),
  ...
  WHITE_SPACE ("white-space",
               ...
               ECSSSpecification.CSS2,
               ECSSSpecification.CSS_TEXT_3),
  WIDOWS ("widows", ECSSVersion.CSS21, ECSSSpecification.CSS2, ECSSSpecification.CSS_BREAK_3),
  WIDTH ("width",
         ECSSVersion.CSS10,
         ECSSSpecification.CSS1,
         ECSSSpecification.CSS2,
  ...
  WORD_BREAK ("word-break", ECSSVersion.CSS30, ECSSSpecification.CSS_TEXT_3),
  ...
  WORD_WRAP ("word-wrap", ECSSVersion.CSS30, ECSSSpecification.CSS_TEXT_3),
  ...
  WRITING_MODE ("writing-mode", ECSSVersion.CSS30, ECSSSpecification.CSS_WRITING_MODES_3),
  ZOOM ("zoom", ECSSVersion.CSS30, ECSSSpecification.CSS_DEVICE_ADAPT_1),
  Z_INDEX ("z-index", ECSSVersion.CSS21, ECSSSpecification.CSS2, ECSSSpecification.CSS_POSITION_3),

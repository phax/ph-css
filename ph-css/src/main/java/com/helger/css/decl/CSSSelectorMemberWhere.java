...
/**
 * Represents complex CSS selector as used for the ":where()" CSS pseudo
 * class function.
 *
 ...
 */
@NotThreadSafe
public class CSSSelectorMemberWhere implements ICSSSelectorMember, ICSSVersionAware, ICSSSourceLocationAware
{
  private final ICommonsList <CSSSelector> m_aNestedSelectors;
  private CSSSourceLocation m_aSourceLocation;

  public CSSSelectorMemberWhere (@Nonnull final CSSSelector aNestedSelector)
  {
    ValueEnforcer.notNull (aNestedSelector, "NestedSelector");
    m_aNestedSelectors = new CommonsArrayList <> (aNestedSelector);
  }

  public CSSSelectorMemberWhere (@Nonnull final CSSSelector... aNestedSelectors)
  {
    ValueEnforcer.notNull (aNestedSelectors, "NestedSelectors");
    m_aNestedSelectors = new CommonsArrayList <> (aNestedSelectors);
  }

  public CSSSelectorMemberWhere (@Nonnull final Iterable <CSSSelector> aNestedSelectors)
  {
    ValueEnforcer.notNull (aNestedSelectors, "NestedSelectors");
    m_aNestedSelectors = new CommonsArrayList <> (aNestedSelectors);
  }
  ...
  @Nonnull
  public CSSSelectorMemberWhere addSelector (@Nonnull final ICSSSelectorMember aSingleSelectorMember)
  {
  ...
  @Nonnull
  public CSSSelectorMemberWhere addSelector (@Nonnull final CSSSelector aSelector)
  {
  ...
  @Nonnull
  public CSSSelectorMemberWhere addSelector (@Nonnegative final int nIndex, @Nonnull final ICSSSelectorMember aSingleSelectorMember)
  {
    ValueEnforcer.notNull (aSingleSelectorMember, "SingleSelectorMember");
  ...
  @Nonnull
  public CSSSelectorMemberWhere addSelector (@Nonnegative final int nIndex, @Nonnull final CSSSelector aSelector)
  {
  ...
  public boolean equals (final Object o)
  {
    ...
    if (o == null || !getClass ().equals (o.getClass ()))
      return false;
    final CSSSelectorMemberWhere rhs = (CSSSelectorMemberWhere) o;

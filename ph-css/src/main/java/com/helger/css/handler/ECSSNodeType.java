...
public enum ECSSNodeType
{
  ...
  STYLEDECLARATIONLISTWITHNESTED (ParserCSS30TreeConstants.JJTSTYLEDECLARATIONLISTWITHNESTED),
  ...
  NESTING (ParserCSS30TreeConstants.JJTNESTING),
  ...
  MEDIARANGEOPERATOR (ParserCSS30TreeConstants.JJTMEDIARANGEOPERATOR),
  // layer stuff

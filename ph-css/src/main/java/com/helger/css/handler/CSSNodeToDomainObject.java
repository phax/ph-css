...
{
  private static final Logger LOGGER = LoggerFactory.getLogger (CSSNodeToDomainObject.class);
                                                          ...
                                                          @Nonnull final CascadingStyleSheet ret)
  {
    ...
    for (final CSSNode aChildNode : aNode)
    {
      if (LOGGER.isTraceEnabled ())
        LOGGER.trace ("Adding child node: " + aChildNode.getNodeType () + " - " + aChildNode.getSourceLocation ());
